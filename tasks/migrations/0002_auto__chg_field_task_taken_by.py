...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.taken_by'
        db.alter_column(u'tasks_task', 'taken_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Task.taken_by'
        db.alter_column(u'tasks_task', 'taken_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.User']))
